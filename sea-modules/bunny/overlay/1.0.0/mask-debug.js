define("bunny/overlay/1.0.0/mask-debug", [ "$-debug", "./overlay-debug", "bunny/position/1.0.0/position-debug", "bunny/iframe-shim/1.0.0/iframe-shim-debug", "bunny/widget/1.0.0/widget-debug" ], function(require, exports, module) {
...
define("bunny/overlay/1.0.0/overlay-debug", [ "$-debug", "bunny/position/1.0.0/position-debug", "bunny/iframe-shim/1.0.0/iframe-shim-debug", "bunny/widget/1.0.0/widget-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), Position = require("bunny/position/1.0.0/position-debug"), Shim = require("bunny/iframe-shim/1.0.0/iframe-shim-debug"), Widget = require("bunny/widget/1.0.0/widget-debug");
    // Overlay
    // -------
