define("bunny/iframe-shim/1.0.0/iframe-shim-debug", [ "$-debug", "bunny/position/1.0.0/position-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var Position = require("bunny/position/1.0.0/position-debug");
