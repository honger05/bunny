define("jquery/area/1.0.0/area-debug", [ "$-debug", "jquery/area/1.0.0/location-debug", "jquery/select2/3.5.2/select2-debug" ], function(require) {
    var $ = require("$-debug");
    var Location = require("./location-debug");
    require("jquery/select2/3.5.2/select2-debug");
...
define("jquery/area/1.0.0/location-debug", [ "$-debug", "jquery/select2/3.5.2/select2-debug" ], function(require) {
    var $ = require("$-debug");
    require("jquery/select2/3.5.2/select2-debug");
    function Location() {
        this.items = {
